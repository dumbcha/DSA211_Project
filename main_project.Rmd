...
consider. We have to condense them accordingly. To understand the dataset more, we can visualise each block on the map and designate their respective subzone. We categorise them in this manner as each neighborhood will have close proximity to their respective facilities, such as schools, malls, childcare centre, etc.
